        ...
        <div className="modal-body">
          ...
          <form className="my-3">
            <div className="mb-3">
              ...
              <input type="text" value={Note.etitle} className="form-control" name="etitle" id="etitle" aria-describedby="emailHelp" onChange={onchange}/>
            </div>
            <div className="mb-3">
              <label htmlFor="edescription" className="form-label">Description</label>
              <input type="text" value={Note.edescription} className="form-control" name="edescription" id="edescription" onChange={onchange}/>
            </div>
