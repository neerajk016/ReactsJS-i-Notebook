// Installing bcryptjs package=>npm i bcryptjs
// installing webtoken =>npm i jsonwebtoken
...
//  if there are errors return bad requests and the errors
    ...
    user=await User.create({
        ...
        password: secpass,//giving secpass(hashpassword) as password
    });



    const data={//sample json data
        user:{
            id:user.id
        }
    }
